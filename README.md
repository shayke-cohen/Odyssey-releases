...
1. Download the latest **Odyssey-x.x.x.dmg** from [Releases](https://github.com/shayko-chen/Odyssey-releases/releases)
...
This is the **public releases** repository. Source code lives in the private Odyssey repo.
